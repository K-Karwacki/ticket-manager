...
public class FXMLPath
{
  ...
  public final static String USER_FORM_POPUP = "fxml/popups/user_creator_popup.fxml";
  public final static String EDIT_USER_POPUP = "fxml/popups/user_editor_popup.fxml";
